            ...
            <div class="col-9 res-list">
              ...
              <div class="col-3 position-relative d-flex justify-content-center add-res-modal">
                ...
                <!-- Button trigger modal -->
                  <button type="button" class="btn-add-res text-wrap flex-shrink-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fas fa-user-plus"></i> Add Resident </button>
